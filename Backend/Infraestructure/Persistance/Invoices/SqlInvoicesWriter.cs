...
namespace Infraestructure.Persistance.Invoices
{
    public class SqlInvoicesWriter : IInvoiceWriter
    {
        ...
        public async Task<Invoice> CreateAsync(Invoice invoiceData, List<InvoiceDetail> invoiceDetails, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                invoiceItemsDetailTable.Columns.Add("Nota", typeof(string));
                ...
                var IItems = cmd.Parameters.AddWithValue("@Items", invoiceItemsDetailTable);
                IItems.SqlDbType = SqlDbType.Structured;
                IItems.TypeName = "dbo.InvoiceItemTVP";
